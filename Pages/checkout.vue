<template>
  <MainLayout class="max-h-screen overflow-x-scroll">
    <div id="CheckoutPage" class="max-w-[1200px] mx-auto px-2">
      <div class="md:flex gap-4 justify-between mx-auto w-full md:-mt-20">
        <div class="md:w-[65%]">
          <div class="bg-white rounded-lg p-4">
            <div class="text-xl font-semibold mb-2">Shipping Address</div>
            <div v-if="currentAddress && currentAddress.data" class="">
              <nuxt-link
                to="/address"
              ...
              <div class="pt-2 border-t">
                <div class="underline pb-">Delivery Address</div>
                <ul class="text-xs">
