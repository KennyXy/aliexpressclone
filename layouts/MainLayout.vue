<template>
    <div id="MainLayout" class="w-full fixed z-50 h-screen">
        <div id="TopMenue" class="w-full bg-[#FAFAFA] border-b md:block hidden">
            <ul class="flex items-center justify-end text-xs text-[#333333] font-light px-2 h-10 bg-[#fafafa] max-w-[1200px]">
                ...
                <li class=" flex px-3 hover:text-[#ff4646] cursor-point">
                ...
                :class="isAccountMenu ? 'bg-white border  shadow-[0_15px_80px_40px_rgba(0,0,0,0.3)]' : 'border border-[#fafafa]'"
                >
               ...
               >
                ...
                <div class="border-b">
                    <ul class="bg-white">
                        ...
                        class="tetxt-[13px] py-2 px-4 w-full hover:bg-gray-200">
                         My Orders
                        </li>
                        <li
                        v-if="user"
        ...
        class="flex items-center w-full bg-white">
           <div class="flex  justify-between gap-10 max-w-[1150px] w-full px-3 py-5 mx-auto lg:justify-start">
               <NuxtLink
               to="/"
               class="min-w-[17opx]">
            <img  width="170" src="/AliExpress-logo.png" alt="something">
            </NuxtLink>

            <div class="max-w-[700px] w-full md:block hidden">
                <div class="relative">
                    <div class="flex item-center border-2 border-[#ff4646] rounded-md w-full">
                        <input
                          class="
                          w-full
                          py-1
                ...
                <div class="absolute bg-white max-w-[700px] h-auto w-full">
                    ...
                    class="p-1">
                        <NuxtLink 
                        :to="`/item/${item.id}`"
                        class="flex items-center justify-between w-full cursor-pointer hoover:bg-gray-100"
                        >
                        <div class="flex items-center">
                            <img class="rounded-md" width="40" :src="item.image" alt="something happened">
...
<script setup>
  ...
  const user = useSupabaseUser()
    ...
    const searchBynName = useDebounce(async () => {
