<template>
    <div class=" flex justify-start my-2">
        ...
        <img class="rounded-md md:w-[120px] w-[90px] p-2" :src="product.image" alt="">
        ...
        <div class="overflow-hidden pl-2 w-full">
            <div class="flex items-center justify-between w-full">
                <div class="flex items-center justify-between truncate">
                    ...
                    <div class="truncate sm:pl-2 font-semibold"> {{ product.title }}</div>
                </div>

                <button @click="removeFromCart()" class="mx-3 sm:block hidden -mt-0.5 hover:text-red-500">
                    <Icon name="material-symbols:delete-outline-sharp" size="20"></Icon>
                </button>
            ...
            <p class="text-[#009a66] text-xs font-semibold pt-1">
                Free 11-days delivery over £8.99
